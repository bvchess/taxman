...
Both directions are proven in [THEORY.md](THEORY.md) — the harder
one by the Franklín–Moniot lifting argument turned inward, whose
...
the frontier jam is hyperedge-free (THEORY.md), exhaustively
